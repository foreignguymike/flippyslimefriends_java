...
public class IconButton extends ImageButton {
    ...
    public IconButton(TextureRegion textImage, TextureRegion bgImage) {
        this(textImage, bgImage, 0, 0, 0);
    }

    public IconButton(TextureRegion textImage, TextureRegion bgImage, float x, float y) {
        this(textImage, bgImage, x, y, 0);
    }

    public IconButton(TextureRegion textImage, TextureRegion bgImage, float x, float y, float padding) {
